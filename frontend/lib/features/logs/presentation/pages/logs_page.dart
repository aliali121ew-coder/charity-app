      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            Expanded(child: Text(label, style: GoogleFonts.cairo(fontSize: 10, color: isDark ? AppColors.textSecondaryDark : AppColors.textSecondaryLight), maxLines: 1, overflow: TextOverflow.ellipsis)),
          ]),
          const SizedBox(height: 4),
          Flexible(
            child: Text(value, style: GoogleFonts.cairo(fontSize: 18, fontWeight: FontWeight.w800, color: color, height: 1.1), maxLines: 1, overflow: TextOverflow.ellipsis),
          ),
        ],
      ),
    );
