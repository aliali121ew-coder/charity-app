    ...
    return Scaffold(
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final targetHeight = 162.0 * textScale + 14.0;
                final gridAspectRatio = (cardWidth / targetHeight).clamp(0.68, 1.25);
      ...
      bottomNavigationBar: _selected != null
          ? _BottomBar(
              ...
              isDark: isDark,
              onNext: () => context.push(
                  '/help-requests/location/${_selected!.name}'),
            )
          : null,
    );
  }
